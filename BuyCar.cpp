...
class BuyCar
{
  ...
  while(currentPriceOld + savings < currentPriceNew){
    currentPriceOld = currentPriceOld*(1-(percentLossByMonth/100));
    currentPriceNew = currentPriceNew*(1-(percentLossByMonth/100));
  ...
  answer.push_back(months);
  answer.push_back(currentPriceOld + savings - currentPriceNew + 0.5);
